...
UPDATE_PACKAGE "app-adguardhome" "sirpdboy/luci-app-adguardhome" "js" "" "luci-app-adguardhome"
UPDATE_PACKAGE "app-netdata" "sirpdboy/luci-app-netdata" "main" "" "luci-app-netdata"
UPDATE_PACKAGE "taskplan" "sirpdboy/luci-app-taskplan" "main" "" "luci-app-taskplan"
